    ...
    return (
      <Layout>
        ...
        <div className="container mx-auto px-6 my-12">
          <p className="my-6">Welcome to PMI Total Fitness Website!</p>
          <p className="my-6">
            These terms and conditions outline the rules and regulations for the
            use of PMI Total Fitness's Website, located at pmitotalfitness.com.
          </p>
          <p className="my-6">
            By accessing this website we assume you accept these terms and
            conditions. Do not continue to use PMI Total Fitness Website if you
          ...
          <h4>Cookies</h4>
          <p className="my-6">
            We employ the use of cookies. By accessing PMI Total Fitness
            Website, you agreed to use cookies in agreement with the PMI Total
          ...
          <h4>License</h4>
          <p className="my-6">
            Unless otherwise stated, PMI Total Fitness and/or its licensors own
            the intellectual property rights for all material on PMI Total
            Fitness Website. All intellectual property rights are reserved. You
            may access this from PMI Total Fitness Website for your own personal
            use subjected to restrictions set in these terms and conditions.
          </p>
          <p className="my-6">
            You must not:
            <ul className="pl-12" style={{ listStyleType: "circle" }}>
              <li>Republish material from PMI Total Fitness Website</li>
              <li>
                Sell, rent or sub-license material from PMI Total Fitness
                Website
              </li>
              <li>
                Reproduce, duplicate or copy material from PMI Total Fitness
                Website
              </li>
              <li>Redistribute content from PMI Total Fitness Website</li>
            </ul>
          </p>
          <p className="my-6">This Agreement shall begin on the date hereof.</p>
          <p className="my-6">
            Parts of this website offer an opportunity for users to post and
            exchange opinions and information in certain areas of the website.
            PMI Total Fitness does not filter, edit, publish or review Comments
            prior to their presence on the website. Comments do not reflect the
            views and opinions of PMI Total Fitness,its agents and/or
            ...
            applicable laws, PMI Total Fitness shall not be liable for the
          ...
          <p className="my-6">
            PMI Total Fitness reserves the right to monitor all Comments and to
          ...
          <p className="my-6">
            You hereby grant PMI Total Fitness a non-exclusive license to use,
          ...
          <p className="my-6">
            ...
            visibility of the hyperlink compensates the absence of PMI Total
            Fitness; and (d) the link is in the context of general resource
            information.
          </p>
          <p className="my-6">
          ...
          <p className="my-6">
            ...
            sending an e-mail to PMI Total Fitness. Please include your name,
          ...
          <p className="my-6">
            No use of PMI Total Fitness's logo or other artwork will be allowed
          ...
          <h4>Your Privacy</h4>
          <p className="my-6">Please read Privacy Policy</p>
